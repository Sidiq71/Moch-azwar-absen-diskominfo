                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.karyawan.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror" id="jam_masuk" name="jam_masuk" value="{{ old('jam_masuk', '08:00') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control @error('jam_pulang') is-invalid @enderror" id="jam_pulang" name="jam_pulang" value="{{ old('jam_pulang', '17:00') }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mb-2">
                                <img id="fotoPreview" src="{{ asset('build/RobloxScreenShot20251113_092815183.png') }}" alt="Preview Foto" class="rounded-circle" style="width: 150px; height: 150px; object-fit: cover; border: 3px solid #f0f0f0;">
                            </div>
                            ...
                            <small class="text-muted d-block mt-2">Format: JPG, PNG, GIF (Max: 2MB). Jika kosong akan menggunakan foto default.</small>
